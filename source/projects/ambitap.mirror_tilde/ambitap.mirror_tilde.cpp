...
public:
    ...
    attribute<bool> flip_lr {
        this, "flip_lr", false, description {"Mirror left/right."},
        setter {MIN_FUNCTION {
    ...
    attribute<bool> flip_fb {
        this, "flip_fb", false, description {"Mirror front/back."},
        setter {MIN_FUNCTION {
            const bool on = args[0];
            if (m_mirror)
    ...
    attribute<bool> flip_ud {
        this, "flip_ud", false, description {"Mirror up/down."},
        setter {MIN_FUNCTION {
            const bool on = args[0];
            if (m_mirror)
