...
public:
    ...
    attribute<number> yaw {
        this, "yaw", 0.0,
        description {"Rotation about +Z (up), radians. Applied first."},
        setter {MIN_FUNCTION {
    ...
    attribute<number> pitch {
        this, "pitch", 0.0,
        description {"Rotation about +Y (left), radians. Applied second."},
        setter {MIN_FUNCTION {
            const double v = args[0];
            if (m_rotator)
    ...
    attribute<number> roll {
        this, "roll", 0.0,
        description {"Rotation about +X (front), radians. Applied last."},
        setter {MIN_FUNCTION {
            const double v = args[0];
            if (m_rotator)
