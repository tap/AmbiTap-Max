...
attribute<number> attenuation{this, "attenuation", 1.0,
...
attribute<number> air_absorption{this, "air_absorption", 0.0,
...
attribute<number> speed_of_sound{this, "speed_of_sound", 343.0,
...
attribute<bool> doppler_enabled{this, "doppler", true,
                                description{"Enable the propagation delay (Doppler on distance modulation)."}};

attribute<bool> nfc_enabled{this, "nfc", true,
